export const mock = `
  <div class="q-container">
     <div class="q-wrapper">
        <p class="quote-p">1. “<a class="quote-a" href="https://quotefancy.com/quote/4237/Taylor-Swift-Just-be-yourself-there-is-no-one-better">Just be yourself, there is no one better.</a>”</p>
